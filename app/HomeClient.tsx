        ...
        <main className="app-container">
            <header className="app-header" style={{ position: 'relative' }}>
                <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                    <div className="header-icon" style={{ position: 'relative', zIndex: 10 }}>😈​</div>
                    
                    <div style={{ position: 'relative', width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '10px' }}>
                        
                        <div style={{ position: 'absolute', top: '-45px', left: 0, right: 0, height: '220px', display: 'flex', justifyContent: 'center', zIndex: 0 }}>
                        ...
                        <div style={{ position: 'relative', zIndex: 1, marginTop: '110px', paddingBottom: '10px' }}>
                            <h1 style={{ textShadow: '0px 2px 8px rgba(0,0,0,0.9)', textAlign: 'center', marginBottom: '8px' }}>Viaje a Amsterdam</h1>
                            <p className="header-sub" style={{ textShadow: '0px 2px 6px rgba(0,0,0,0.9)', textAlign: 'center' }}>Seleccionate para apuntar el vicio</p>
                        </div>
                    </div>
                    <Link
                        href="/stats"
